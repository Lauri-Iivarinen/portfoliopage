...
export const GetIcon: React.FC<Props> = ({ iconName }) => {
    ...
    const fetchIcon = (name: string) => {
        switch (name) {
            case 'React':
                return <SiReact size={30} color='#9442c1'></SiReact>
            case 'React Native':
                return <SiReact size={30} color='#9442c1'></SiReact>
            case 'JavaScript':
                return <SiJavascript size={30} color='#9442c1'></SiJavascript>
            case 'TypeScript':
                return <SiTypescript size={30} color='#9442c1'></SiTypescript>
            case 'Express':
                return <SiExpress size={30} color='#9442c1'></SiExpress>
            case 'Relational databases':
                return <DiMysql size={30} color='#9442c1'></DiMysql>
            case 'Spring Boot':
                return <SiSpring size={30} color='#9442c1'></SiSpring>
            case 'Python':
                return <SiPython size={30} color='#9442c1'></SiPython>
            case 'Docker':
                return <SiDocker size={30} color='#9442c1'></SiDocker>
            case 'Robot Framework':
                return <SiRobotframework size={30} color='#9442c1'></SiRobotframework>
            case 'Component Libraries':
                return <SiMui size={30} color='#9442c1'></SiMui>
            case 'GitHub actions':
                return <SiGithubactions size={30} color='#9442c1'></SiGithubactions>
            case 'Java':
                return <DiJava size={30} color='#9442c1'></DiJava>
            case 'SQL':
                return <DiDatabase size={30} color='#9442c1'></DiDatabase>
            case 'Pygame':
                return <PiGameControllerBold size={30} color='#9442c1'></PiGameControllerBold>
            case 'DiscordJs':
                return <SiDiscord size={30} color='#9442c1'></SiDiscord>
            case 'REST API':
                return <TbApi size={30} color='#9442c1'></TbApi>
            case 'AI art generation':
                return <TbArtboardFilled size={30} color='#9442c1'></TbArtboardFilled>
            case 'Socket.io':
                return <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32" fill='#9442c1'>
