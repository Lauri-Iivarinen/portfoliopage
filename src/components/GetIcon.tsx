...
export const GetIcon: React.FC<Props> = ({ iconName }) => {
    ...
    const fetchIcon = (name: string) => {
        switch (name) {
            case 'React':
                return <SiReact size={30} color='#16BAC5'></SiReact>
            case 'React Native':
                return <SiReact size={30} color='#16BAC5'></SiReact>
            case 'JavaScript':
                return <SiJavascript size={30} color='#16BAC5'></SiJavascript>
            case 'TypeScript':
                return <SiTypescript size={30} color='#16BAC5'></SiTypescript>
            case 'Express':
                return <SiExpress size={30} color='#16BAC5'></SiExpress>
            case 'Relational databases':
                return <DiMysql size={30} color='#16BAC5'></DiMysql>
            case 'Spring Boot':
                return <SiSpring size={30} color='#16BAC5'></SiSpring>
            case 'Python':
                return <SiPython size={30} color='#16BAC5'></SiPython>
            case 'Docker':
                return <SiDocker size={30} color='#16BAC5'></SiDocker>
            case 'Robot Framework':
                return <SiRobotframework size={30} color='#16BAC5'></SiRobotframework>
            case 'Component Libraries':
                return <SiMui size={30} color='#16BAC5'></SiMui>
            case 'GitHub actions':
                return <SiGithubactions size={30} color='#16BAC5'></SiGithubactions>
            case 'Java':
                return <DiJava size={30} color='#16BAC5'></DiJava>
            case 'SQL':
                return <DiDatabase size={30} color='#16BAC5'></DiDatabase>
            case 'Pygame':
                return <PiGameControllerBold size={30} color='#16BAC5'></PiGameControllerBold>
            case 'DiscordJs':
                return <SiDiscord size={30} color='#16BAC5'></SiDiscord>
            case 'REST API':
                return <TbApi size={30} color='#16BAC5'></TbApi>
            case 'AI art generation':
                return <TbArtboardFilled size={30} color='#16BAC5'></TbArtboardFilled>
            case 'School':
