...
export const UserData = () => {
    ...
    const handleMouseOverButton = (e: any) => {
        e.target.style.cssText = "border-color: #16BAC5;"
    }

    const handleMouseLeaveButton = (e: any) => {
        e.target.style.cssText = "border-color: inherit;"
    }
            ...
            <Box sx={{ borderWidth: 1, borderRadius: 2, borderStyle: 'solid', padding: 2, width: 320, height: 290 }}>
                ...
                >
                    <BottomNavigationAction
                        sx={{ borderWidth: 1, borderColor: 'secondary', borderStyle: 'solid', paddingTop: 1, paddingBottom: 1, marginRight: 1 }}
                        onMouseEnter={handleMouseOverButton}
                        onMouseLeave={handleMouseLeaveButton}
                        label="CLASSIC"
                        icon={<AbcIcon />}
                    />
                    <BottomNavigationAction
                        sx={{ borderWidth: 1, borderColor: 'secondary', borderStyle: 'solid', paddingTop: 1, paddingBottom: 1, marginLeft: 1 }}
                        onMouseEnter={handleMouseOverButton}
                        onMouseLeave={handleMouseLeaveButton}
                        label="JSON"
                        icon={<JavascriptIcon />}
